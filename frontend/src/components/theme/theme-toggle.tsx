    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="relative w-8 h-8 rounded-full hover:bg-slate-100 dark:hover:bg-white/5 transition-all duration-300"
        >
      ...
      <DropdownMenuContent
        align="end"
        className="bg-background border-slate-200 dark:border-white/10 shadow-lg"
      >
        <DropdownMenuItem
