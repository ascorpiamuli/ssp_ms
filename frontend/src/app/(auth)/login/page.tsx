...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isSubmitting.current || isLoadingState) return
    ...
    <div className="space-y-5">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={cn(
                "pl-10 border-slate-200 dark:border-white/10 focus:border-blue-500 focus:ring-blue-500",
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              ...
              placeholder="••••••••"
              className={cn(
                "pl-10 pr-10 border-slate-200 dark:border-white/10 focus:border-blue-500 focus:ring-blue-500",
        ...
        <div className="flex items-center">
          <input
            id="remember-me"
            type="checkbox"
            className="h-4 w-4 rounded border-slate-300 text-blue-600 focus:ring-blue-500 dark:border-white/20 dark:bg-white/5"
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center">
          <span className="bg-white dark:bg-background px-3 text-xs text-slate-500 dark:text-slate-400">
            Or continue with
          </span>
        </div>
      </div>
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full flex items-center justify-center gap-3 py-5 border-2 border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-white/5 transition-all group"
        disabled={isLoadingState || loginSuccess}
      >
