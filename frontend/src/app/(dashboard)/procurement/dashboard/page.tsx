...
export default function ProcurementDashboardPage() {
  ...
  const statsItems: StatCardItem[] = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        tagLabel: "RATE",
        tagColor: "purple",
        subtitle: `${Math.round(avgResponseRate)}% average`,
        suffix: '%',
        compact: false,
      },
      {
  ...
  }, [procurementStats, totalQtns, activeCount, closingSoonCount, avgResponseRate, supplierQuoteCount, totalRequisitions, readyForProcurement, inProgress, completed]);
  ...
  return (
    ...
    >
      {/* ============================================ */}
      {/* SECTION 1: KEY METRICS - StatsCards Component */}
      {/* ============================================ */}
      ...
      <div className="mt-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3">
          <button
            onClick={() => router.push('/procurement/request-for-quotations/create')}
            className="flex flex-col items-center justify-center p-4 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 hover:border-solid hover:border-blue-500 dark:hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-300 group"
          >
            <div className="p-3 rounded-xl bg-blue-50 dark:bg-blue-900/20 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/30 transition-all duration-300">
              <Plus className="h-6 w-6 text-blue-600 dark:text-blue-400" />
            </div>
            <span className="text-sm font-medium mt-2 text-gray-700 dark:text-gray-300">Create RFQ</span>
            <span className="text-xs text-muted-foreground mt-0.5">New request</span>
          </button>
          <button
            onClick={() => router.push('/procurement/request-for-quotations/manage')}
            className="flex flex-col items-center justify-center p-4 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 hover:border-solid hover:border-purple-500 dark:hover:border-purple-500 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-300 group"
          >
            <div className="p-3 rounded-xl bg-purple-50 dark:bg-purple-900/20 group-hover:bg-purple-100 dark:group-hover:bg-purple-900/30 transition-all duration-300">
              <FileText className="h-6 w-6 text-purple-600 dark:text-purple-400" />
            </div>
            <span className="text-sm font-medium mt-2 text-gray-700 dark:text-gray-300">View RFQs</span>
            <span className="text-xs text-muted-foreground mt-0.5">All RFQs</span>
          </button>
          <button
            onClick={() => router.push('/procurement/suppliers')}
            className="flex flex-col items-center justify-center p-4 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 hover:border-solid hover:border-emerald-500 dark:hover:border-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-all duration-300 group"
          >
            <div className="p-3 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 group-hover:bg-emerald-100 dark:group-hover:bg-emerald-900/30 transition-all duration-300">
              <Users className="h-6 w-6 text-emerald-600 dark:text-emerald-400" />
            </div>
            <span className="text-sm font-medium mt-2 text-gray-700 dark:text-gray-300">Manage Suppliers</span>
            <span className="text-xs text-muted-foreground mt-0.5">Supplier list</span>
          </button>
          <button
            onClick={() => router.push('/procurement/purchase-orders/manage-orders')}
            className="flex flex-col items-center justify-center p-4 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 hover:border-solid hover:border-amber-500 dark:hover:border-amber-500 hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-all duration-300 group"
          >
            <div className="p-3 rounded-xl bg-amber-50 dark:bg-amber-900/20 group-hover:bg-amber-100 dark:group-hover:bg-amber-900/30 transition-all duration-300">
              <ShoppingCart className="h-6 w-6 text-amber-600 dark:text-amber-400" />
            </div>
            <span className="text-sm font-medium mt-2 text-gray-700 dark:text-gray-300">Purchase Orders</span>
            <span className="text-xs text-muted-foreground mt-0.5">LPO/LSO</span>
          </button>
          <button
            onClick={() => router.push('/procurement/invoices')}
            className="flex flex-col items-center justify-center p-4 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 hover:border-solid hover:border-rose-500 dark:hover:border-rose-500 hover:bg-rose-50 dark:hover:bg-rose-900/20 transition-all duration-300 group"
          >
            <div className="p-3 rounded-xl bg-rose-50 dark:bg-rose-900/20 group-hover:bg-rose-100 dark:group-hover:bg-rose-900/30 transition-all duration-300">
              <Receipt className="h-6 w-6 text-rose-600 dark:text-rose-400" />
            </div>
            <span className="text-sm font-medium mt-2 text-gray-700 dark:text-gray-300">Invoices</span>
            <span className="text-xs text-muted-foreground mt-0.5">Supplier invoices</span>
          </button>
          <button
            onClick={() => router.push('/procurement/reports')}
            className="flex flex-col items-center justify-center p-4 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 hover:border-solid hover:border-indigo-500 dark:hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-all duration-300 group"
          >
            <div className="p-3 rounded-xl bg-indigo-50 dark:bg-indigo-900/20 group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900/30 transition-all duration-300">
              <BarChart3 className="h-6 w-6 text-indigo-600 dark:text-indigo-400" />
            </div>
            <span className="text-sm font-medium mt-2 text-gray-700 dark:text-gray-300">Reports</span>
            <span className="text-xs text-muted-foreground mt-0.5">Analytics</span>
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 mt-6">
        ...
        <Card className="border-0 shadow-sm rounded-2xl bg-white dark:bg-gray-900 overflow-hidden hover:shadow-md transition-all duration-300 flex-1">
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center gap-3.5 p-4 bg-white dark:bg-gray-900 rounded-xl border border-blue-200 dark:border-blue-800 cursor-pointer hover:shadow-md hover:scale-[1.02] transition-all duration-200" onClick={() => router.push('/requisitions/manage')}>
              <div className="p-2.5 rounded-xl bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400">
                <ClipboardList className="h-4 w-4" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider truncate">Total Requisitions</p>
                <p className="text-lg font-bold mt-0.5 text-gray-900 dark:text-gray-100">{totalRequisitions}</p>
              </div>
            </div>
            <div className="flex items-center gap-3.5 p-4 bg-white dark:bg-gray-900 rounded-xl border border-emerald-200 dark:border-emerald-800 cursor-pointer hover:shadow-md hover:scale-[1.02] transition-all duration-200" onClick={() => router.push('/procurement/request-for-quotations/create')}>
              <div className="p-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400">
                <Rocket className="h-4 w-4" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider truncate">Ready for RFQ</p>
                <p className="text-lg font-bold mt-0.5 text-gray-900 dark:text-gray-100">{readyForProcurement}</p>
              </div>
            </div>
            <div className="flex items-center gap-3.5 p-4 bg-white dark:bg-gray-900 rounded-xl border border-amber-200 dark:border-amber-800 cursor-pointer hover:shadow-md hover:scale-[1.02] transition-all duration-200">
              <div className="p-2.5 rounded-xl bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400">
                <Timer className="h-4 w-4" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider truncate">In Progress</p>
                <p className="text-lg font-bold mt-0.5 text-gray-900 dark:text-gray-100">{inProgress}</p>
              </div>
            </div>
            <div className="flex items-center gap-3.5 p-4 bg-white dark:bg-gray-900 rounded-xl border border-teal-200 dark:border-teal-800 cursor-pointer hover:shadow-md hover:scale-[1.02] transition-all duration-200">
              <div className="p-2.5 rounded-xl bg-teal-50 dark:bg-teal-900/20 text-teal-600 dark:text-teal-400">
                <CheckCircle className="h-4 w-4" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider truncate">Completed</p>
                <p className="text-lg font-bold mt-0.5 text-gray-900 dark:text-gray-100">{completed}</p>
              </div>
            </div>
            <div className="flex items-center gap-3.5 p-4 bg-white dark:bg-gray-900 rounded-xl border border-purple-200 dark:border-purple-800 cursor-pointer hover:shadow-md hover:scale-[1.02] transition-all duration-200" onClick={() => router.push('/procurement/request-for-quotations/manage')}>
              <div className="p-2.5 rounded-xl bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400">
                <FileCheck className="h-4 w-4" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider truncate">With QTNs</p>
                <p className="text-lg font-bold mt-0.5 text-gray-900 dark:text-gray-100">{withQtns}</p>
              </div>
            </div>
            <div className="flex items-center gap-3.5 p-4 bg-white dark:bg-gray-900 rounded-xl border border-rose-200 dark:border-rose-800 cursor-pointer hover:shadow-md hover:scale-[1.02] transition-all duration-200">
              <div className="p-2.5 rounded-xl bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400">
                <XCircle className="h-4 w-4" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider truncate">Without QTNs</p>
                <p className="text-lg font-bold mt-0.5 text-gray-900 dark:text-gray-100">{withoutQtns}</p>
              </div>
            </div>
            <div className="flex items-center gap-3.5 p-4 bg-white dark:bg-gray-900 rounded-xl border border-indigo-200 dark:border-indigo-800">
              <div className="p-2.5 rounded-xl bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400">
                <Gauge className="h-4 w-4" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider truncate">Completion Rate</p>
                <p className="text-lg font-bold mt-0.5 text-gray-900 dark:text-gray-100">{totalRequisitions > 0 ? `${Math.round((completed / totalRequisitions) * 100)}%` : '0%'}</p>
              </div>
            </div>
            <div className="flex items-center gap-3.5 p-4 bg-white dark:bg-gray-900 rounded-xl border border-cyan-200 dark:border-cyan-800 cursor-pointer hover:shadow-md hover:scale-[1.02] transition-all duration-200" onClick={() => router.push('/procurement/suppliers')}>
              <div className="p-2.5 rounded-xl bg-cyan-50 dark:bg-cyan-900/20 text-cyan-600 dark:text-cyan-400">
                <Store className="h-4 w-4" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider truncate">Total Suppliers</p>
                <p className="text-lg font-bold mt-0.5 text-gray-900 dark:text-gray-100">{suppliers.length}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-xs mt-1">Daily RFQ creation over {timeRange}</CardDescription>
              </div>
          ...
          <CardContent className="p-4 pt-0">
            <div className="relative" style={{ height: 350 }}>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <FunnelChart>
                  ...
                  >
                    ...
                    <LabelList dataKey="value" position="right" fill="#6b7280" fontSize={12} fontWeight="semibold" className="dark:text-gray-400" formatter={(value: any) => typeof value === 'number' ? value.toLocaleString() : value} />
                  </Funnel>
                  <RechartsTooltip content={({ active, payload }: any) => {
                    if (!active || !payload) return null;
                    return (
              ...
              <div className="absolute bottom-4 left-4 right-4 flex justify-between text-[10px] text-muted-foreground">
                <span>Start: {totalRequisitions}</span>
                <span>End: {completed}</span>
                <span>Drop-off: {totalRequisitions - completed}</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-sm rounded-2xl bg-white dark:bg-gray-900 overflow-hidden hover:shadow-xl transition-all duration-500 group">
          ...
          <CardContent className="p-4 pt-0">
            <div className="relative" style={{ height: 350 }}>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={[
                  { label: '$0 - $1K', count: quotations.filter((q: QuotationRequest) => (q.requisition?.total_amount || 0) >= 0 && (q.requisition?.total_amount || 0) < 1000).length },
                  { label: '$1K - $5K', count: quotations.filter((q: QuotationRequest) => (q.requisition?.total_amount || 0) >= 1000 && (q.requisition?.total_amount || 0) < 5000).length },
                  { label: '$5K - $10K', count: quotations.filter((q: QuotationRequest) => (q.requisition?.total_amount || 0) >= 5000 && (q.requisition?.total_amount || 0) < 10000).length },
                  { label: '$10K - $50K', count: quotations.filter((q: QuotationRequest) => (q.requisition?.total_amount || 0) >= 10000 && (q.requisition?.total_amount || 0) < 50000).length },
                  { label: '$50K - $100K', count: quotations.filter((q: QuotationRequest) => (q.requisition?.total_amount || 0) >= 50000 && (q.requisition?.total_amount || 0) < 100000).length },
                  { label: '$100K+', count: quotations.filter((q: QuotationRequest) => (q.requisition?.total_amount || 0) >= 100000).length },
                ]} layout="vertical" margin={{ left: 80, right: 20, top: 10, bottom: 10 }}>
                  <defs>
                  ...
                  <XAxis type="number" tick={{ fontSize: 10, fill: '#6b7280' }} tickLine={false} axisLine={false} className="dark:text-gray-400" />
                  <YAxis type="category" dataKey="label" tick={{ fontSize: 10, fill: '#6b7280' }} tickLine={false} axisLine={false} width={80} className="dark:text-gray-400" />
                  <RechartsTooltip content={({ active, payload }: any) => {
                    if (!active || !payload) return null;
                    return (
                      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-4 min-w-[180px]">
                        <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{payload[0]?.payload?.label}</p>
                        <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">{payload[0]?.value}</p>
                        <p className="text-xs text-muted-foreground">RFQs in this range</p>
                      </div>
                    );
                  }} />
                  <Bar dataKey="count" name="RFQs" radius={[0, 6, 6, 0]} barSize={28} animationDuration={1000} animationEasing="ease-out">
                    {[
                      { label: '$0 - $1K', count: quotations.filter((q: QuotationRequest) => (q.requisition?.total_amount || 0) >= 0 && (q.requisition?.total_amount || 0) < 1000).length },
                      { label: '$1K - $5K', count: quotations.filter((q: QuotationRequest) => (q.requisition?.total_amount || 0) >= 1000 && (q.requisition?.total_amount || 0) < 5000).length },
                      { label: '$5K - $10K', count: quotations.filter((q: QuotationRequest) => (q.requisition?.total_amount || 0) >= 5000 && (q.requisition?.total_amount || 0) < 10000).length },
                      ...
                      <Cell key={`cell-${index}`} fill={`url(#barGrad-${index})`} style={{ filter: `drop-shadow(0 2px 8px ${CHART_COLORS[index % CHART_COLORS.length]}30)` }} />
                    ))}
                  </Bar>
                </BarChart>
              </ResponsiveContainer>
              <div className="absolute bottom-4 left-4 right-4 flex justify-between text-[10px] text-muted-foreground">
                <span>Min: {quotations.length > 0 ? `$${Math.min(...quotations.map((q: QuotationRequest) => q.requisition?.total_amount || 0)).toLocaleString()}` : 'N/A'}</span>
                <span>Max: {quotations.length > 0 ? `$${Math.max(...quotations.map((q: QuotationRequest) => q.requisition?.total_amount || 0)).toLocaleString()}` : 'N/A'}</span>
                <span>Avg: {quotations.length > 0 ? `$${Math.round(quotations.reduce((acc: number, q: QuotationRequest) => acc + (q.requisition?.total_amount || 0), 0) / quotations.length).toLocaleString()}` : 'N/A'}</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-sm rounded-2xl bg-white dark:bg-gray-900 overflow-hidden hover:shadow-md transition-all duration-300">
          ...
          <CardContent className="p-5 pt-0">
            <div style={{ height: 320 }} className="w-full">
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={supplierQuotations
                  ...
                  <RechartsTooltip content={({ active, payload }: any) => {
                    if (!active || !payload) return null;
                    return (
                      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-4 min-w-[200px]">
                        <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{payload[0]?.payload?.name}</p>
      ...
      {/* ============================================ */}
      {/* SECTION 8: RECENT RFQs & REQUISITIONS */}
      {/* ============================================ */}
          ...
          <CardContent className="p-0">
            <div className="overflow-x-auto">
              <table className="w-full min-w-[600px]">
                ...
                <tbody>
                  {quotations
                    .sort((a: QuotationRequest, b: QuotationRequest) => new Date(b.created_at).getTime() - new Date(a.created_at).getTime())
                    .slice(0, 5)
                    .map((rfq: QuotationRequest) => (
                      <tr
                        key={rfq.id}
        ...
        <Card className="border-0 shadow-sm rounded-2xl bg-white dark:bg-gray-900 overflow-hidden">
          <CardHeader className="pb-2 flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription className="text-xs mt-1">Latest 5 requisitions with status</CardDescription>
            </div>
            <Button
              variant="ghost"
              size="sm"
                  ...
                  {allRequisitions
                    ...
                    .map((req: Requisition) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <Badge className={cn("flex items-center gap-1.5 px-3 py-1 font-medium rounded-full border-0", getRequisitionStatusBgColor(req.status))}>
                            <span className="h-1.5 w-1.5 rounded-full" style={{ backgroundColor: getRequisitionStatusColor(req.status) }} />
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={[
                  ...
                  <RechartsTooltip content={({ active, payload }: any) => {
                    ...
                    return (
                      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-4 min-w-[180px]">
                        <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{payload[0]?.payload?.stage}</p>
                        {payload.map((item: any) => (
                          <div key={item.name} className="flex items-center justify-between gap-4 py-1">
                            <span className="text-sm text-gray-600 dark:text-gray-300">{item.name}</span>
                            <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">{item.value}</span>
...
function getRequisitionStatusBgColor(status: string): string {
  const map: Record<string, string> = {
    draft: 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300',
